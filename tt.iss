...
AppId={{D0CF21CA-39C6-4A73-90F4-A86653ACAD3F}
AppName={#MyAppName}
...
LicenseFile=D:\py-git\gpl-2.0.txt
...
[Files]
Source: "D:\py-git\timetracker\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
